...
function clearHighScores() {
    ...
    // Confirmation prompt
    const confirmClear = confirm("Are you sure you want to clear all high scores? This action cannot be undone.");
...
// Ensure this function is called when the clear button is clicked
